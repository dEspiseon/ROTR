// РђРЅРѕРјР°Р»РёРё РєР°Рє РІ S.T.A.L.K.E.R. РѕС‚ Diwako
force ANOMALY_DEBUG = false;
force ANOMALY_DETECTION_RANGE = 30;
...
force ace_overpressure_distanceCoefficient = -0.00567561;
...
force ace_nametags_playerNamesMaxAlpha = 1;
...
force ace_medical_treatment_cprSuccessChanceMin = 0.744663;
force ace_medical_treatment_graveDiggingMarker = true;
force ace_medical_treatment_holsterRequired = 0;
force ace_medical_treatment_litterCleanupDelay = 239.9;
...
force ace_medical_treatment_treatmentTimeBodyBag = 20.99;
ace_medical_treatment_treatmentTimeCoeffZeus = 1;
force ace_medical_treatment_treatmentTimeCPR = 15;
force ace_medical_treatment_treatmentTimeGrave = 24.005;
force ace_medical_treatment_treatmentTimeIV = 12;
force ace_medical_treatment_treatmentTimeSplint = 9.995;
force ace_medical_treatment_treatmentTimeTourniquet = 1.1;
...
// ACE РџРќР’
force ace_nightvision_aimDownSightsBlur = 0.215221;
force ace_nightvision_disableNVGsWithSights = false;
force ace_nightvision_effectScaling = 0.284092;
force ace_nightvision_fogScaling = 0.335746;
force ace_nightvision_noiseScaling = 0.232439;
...
force ace_advanced_fatigue_performanceFactor = 3.46505;
...
// Achilles - Р”РѕСЃС‚СѓРїРЅС‹Рµ РєСѓСЂР°С‚РѕСЂСѓ СЂРµР¶РёРјС‹ Р·СЂРµРЅРёСЏ
...
// Achilles - Р”РѕСЃС‚СѓРїРЅС‹Рµ РјРѕРґСѓР»Рё
...
Achilles_var_Achilles_Module_Zeus_SwitchUnit = false;
...
// Achilles - Р”РѕСЃС‚СѓРїРЅС‹Рµ С„СЂР°РєС†РёРё
...
Achilles_var_Archons = true;
Achilles_var_Aux501_FactionClasses_Civilians = true;
Achilles_var_Aux501_FactionClasses_Confederacy = true;
Achilles_var_Aux501_FactionClasses_Mandos = true;
Achilles_var_Aux501_FactionClasses_Mercs = true;
...
Achilles_var_DSA_DeltaX = true;
Achilles_var_DSA_Spooks = true;
...
Achilles_var_O_EmpireArmy = true;
...
// Achilles - Р—РЅР°С‡РµРЅРёСЏ РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ
Achilles_var_setRadioFrequenciesLR_Default = "50";
Achilles_var_setRadioFrequenciesSR_Default = "150";

// Achilles - РРЅС‚РµСЂС„РµР№СЃ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ
...
// Aux212 HeadLamps
force Aux212_HeadLamps_IsAIActivateHeadlamps = false;
force Aux212_HeadLamps_IsVolumetricAppearOnAIParam = false;
...
force DBA_StunEnable = false;
force DBA_StunHeavyDroids = false;

// DBA Republic
force DBA_Camo_Changer_Camo_Coef = 0.6;
DBA_Camo_Changer_Hints = true;
...
// DUI - Р Р°РґР°СЂ РєРѕРјР°РЅРґС‹ - РРЅРґРёРєР°С‚РѕСЂС‹
...
// DUI - Р Р°РґР°СЂ РєРѕРјР°РЅРґС‹ - РћСЃРЅРѕРІРЅРѕРµ
...
// DUI - Р Р°РґР°СЂ РєРѕРјР°РЅРґС‹ - Р Р°РґР°СЂ
...
force mti_equipment_flagsEnabled = false;
...
force force mti_fortify_fortifyAllowed = false;
...
// Scion Conflict
force sc_scripts_grapplinghook_coolDown = 0.1;
force sc_scripts_grapplinghook_everyoneHasGrapplingHook = false;
force sc_scripts_grapplinghook_grapplingSpeedCoef = 20;
force sc_scripts_grapplinghook_maxGrapplingTime = 5;
force sc_scripts_grapplinghook_maxRange = 100;
sc_scripts_grapplinghook_safetyCheck = true;
force sc_scripts_jumppack_dodgeCooldown = 1;
force sc_scripts_jumppack_dodgeMultiplier = 7.5;
force sc_scripts_jumppack_everyoneHasJumpPack = false;
force sc_scripts_jumppack_jumpCooldown = 30;
force sc_scripts_jumppack_maxJumpHeightHigh = 15;
force sc_scripts_jumppack_maxJumpHeightLow = 10;
force sc_scripts_jumppack_maxJumpVelocityMultiplier = 3;
...
zen_faction_filter_0_212_Arcus_B1_Faction = true;
...
zen_faction_filter_0_C_CIVEMPCiv_groups = true;
...
zen_faction_filter_0_O_EmpireArmy = true;
zen_faction_filter_0_O_Kalani = true;
zen_faction_filter_0_O_Kalani_groups = true;
...
zen_faction_filter_1_B_DBA_Republic_F = true;
...
zen_faction_filter_3_C_CIVEMPCiv = true;
